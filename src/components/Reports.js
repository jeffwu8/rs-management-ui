      ...
      content = (
        <table align="center">
          <tbody>
            <tr key="gross_sales">
              <td>Gross Sales:</td>
              <td align="center">$ {this.props.report.reportList[0][0].gross_sales_cents / 100.0}</td>
            </tr>
            <tr key="instore_sales">
              <td>In-store Sales:</td>
              <td align="center">{this.props.report.reportList[1][0].instore_sales}</td>
            </tr>
            <tr key="online_sales">
              <td>Online Sales:</td>
              <td align="center">{this.props.report.reportList[2][0].online_sales}</td>
            </tr>
          </tbody>
        </table>
      );
